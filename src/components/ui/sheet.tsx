    ...
    <SheetPortal>
      ...
      >
        ...
        <div className="absolute top-4 right-4 flex items-center gap-5">
          <HeaderSubComponent />
          <SheetPrimitive.Close className="ring-offset-background border-0 focus:ring-ring data-[state=open]:bg-secondary rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
