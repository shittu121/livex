...
const FirstPage = () => {
    ...
    return (
      <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Content Container */}
        <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 w-full max-w-4xl mx-auto">
          {/* Logo Animation */}
          <motion.div
          ...
          >
            Welcome to LiveX, Experience live events like never before
          </motion.h2>
