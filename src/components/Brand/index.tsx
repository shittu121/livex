      ...
      <div className="flex">
        ...
        >
          <div className="block lg:flex md:flex space-y-4 items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold">Brand Dashboard</h1>
          ...
          {/* News & Announcements */}
          <motion.div variants={itemVariants} className="mb-6 hidden">
          ...
          >
            <motion.div variants={itemVariants}>
              <Card className="bg-gradient-to-br from-indigo-600 to-indigo-700 border-indigo-500 hidden">
            ...
            <motion.div variants={itemVariants}>
              <Card className="bg-gradient-to-br from-emerald-600 to-emerald-700 border-emerald-500 hidden">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start">
                    <div>
            ...
            <motion.div variants={itemVariants}>
              <Card className="bg-gradient-to-br from-amber-600 to-amber-700 border-amber-500 hidden">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start">
                    <div>
